 ...
 */
public class RichieMotionProfile implements IFilter {
     ...
     */
    public RichieMotionProfile(Number velLimit, Number accelLimit, int steps) {
     ...
     */
    public RichieMotionProfile(Number velLimit, Number accelLimit) {
